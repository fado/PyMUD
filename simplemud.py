...
# Stores the commands available in the game.
COMMANDS = dict()

def register_command(func):
    '''Adds the decorated function to the dictionary of available commands, using the 
...
while True:
    ...
    for id, command, params in mud.get_commands():
        ...
        # Check and see if the player input matches any registered commands.
